...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_comment', 'ip', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Comment.ip'
        db.alter_column('core_comment', 'ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))
