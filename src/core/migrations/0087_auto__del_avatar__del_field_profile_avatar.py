...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'core_avatar')

        # Deleting field 'Profile.avatar'
        db.delete_column(u'core_profile', 'avatar')


    def backwards(self, orm):
        # Adding model 'Avatar'
        db.create_table(u'core_avatar', (
            ('avatar32', self.gf('yafotki.fields.YFField')(max_length=255)),
            ('avatar16', self.gf('yafotki.fields.YFField')(max_length=255)),
            ('avatar128', self.gf('yafotki.fields.YFField')(max_length=255)),
            ('avatar64', self.gf('yafotki.fields.YFField')(max_length=255)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'core', ['Avatar'])

        # Adding field 'Profile.avatar'
        db.add_column(u'core_profile', 'avatar',
