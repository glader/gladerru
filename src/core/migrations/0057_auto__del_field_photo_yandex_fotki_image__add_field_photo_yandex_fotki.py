...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.yandex_fotki_image_id'
        db.add_column('core_photo', 'yandex_fotki_image_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Photo.yandex_fotki_image_id'
        db.delete_column('core_photo', 'yandex_fotki_image_id')
