...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_photo', 'local_url', self.gf('django.db.models.fields.CharField')(default='', max_length=70), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_photo', 'local_url')
