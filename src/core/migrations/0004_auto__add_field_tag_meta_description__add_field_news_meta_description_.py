...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.meta_description'
        db.add_column(u'core_tag', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'News.meta_description'
        db.add_column(u'core_news', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Skill.meta_description'
        db.add_column(u'core_skill', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Word.meta_description'
        db.add_column(u'core_word', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.meta_description'
        db.add_column(u'core_post', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Rubric.meta_description'
        db.add_column(u'core_rubric', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.meta_description'
        db.delete_column(u'core_tag', 'meta_description')

        # Deleting field 'News.meta_description'
        db.delete_column(u'core_news', 'meta_description')

        # Deleting field 'Skill.meta_description'
        db.delete_column(u'core_skill', 'meta_description')

        # Deleting field 'Word.meta_description'
        db.delete_column(u'core_word', 'meta_description')

        # Deleting field 'Post.meta_description'
        db.delete_column(u'core_post', 'meta_description')

        # Deleting field 'Rubric.meta_description'
        db.delete_column(u'core_rubric', 'meta_description')
