...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tag.need_recalc'
        db.add_column('core_tag', 'need_recalc', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Tag.need_recalc'
        db.delete_column('core_tag', 'need_recalc')
    ...
    models = {
        ...
        'core.item': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'favorites': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['core.Profile']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['core.Tag']", 'symmetrical': 'False', 'null': 'True', 'blank': 'True'}),
