...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_post', 'meta_keywords',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_post', 'meta_keywords')
    ...
    models = {
        ...
        u'core.post': {
            ...
            'meta_keywords': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
