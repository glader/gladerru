...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_picturebox', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('picture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Photo'])),
        ...
        db.send_create_signal('core', ['PictureBox'])

    def backwards(self, orm):

        # Deleting model 'PictureBox'
        db.delete_table('core_picturebox')
