...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.event_date_start'
        db.add_column('core_post', 'event_date_start', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Post.event_date_start'
        db.delete_column('core_post', 'event_date_start')
