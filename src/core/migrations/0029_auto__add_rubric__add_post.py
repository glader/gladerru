...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('core', ['Rubric'])
        ...
        db.create_table('core_post', (
            ...
            ('best_answer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='post_best_answer', null=True, to=orm['core.Comment'])),
        ...
        # Adding M2M table for field favorites on 'Post'
        db.create_table('core_post_favorites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('post', models.ForeignKey(orm['core.post'], null=False)),
    ...
    models = {
        ...
        'core.item': {
            ...
            'best_answer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'best_answer'", 'null': 'True', 'to': "orm['core.Comment']"}),
