...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Post.rubric'
        db.delete_column(u'core_post', 'rubric_id')


        # Changing field 'Post.content'
        db.alter_column(u'core_post', 'content', self.gf('redactor.fields.RedactorField')(null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_rubric', (
            ...
            ('meta_description', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250, null=True, blank=True)),
        ...
        # Adding field 'Post.rubric'
        db.add_column(u'core_post', 'rubric',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Rubric'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Post.content'
        db.alter_column(u'core_post', 'content', self.gf('django.db.models.fields.TextField')(null=True))
