...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Friend', fields ['user_a', 'user_b']
        db.delete_unique(u'core_friend', ['user_a_id', 'user_b_id'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_friend', (
            ('user_a', self.gf('django.db.models.fields.related.ForeignKey')(related_name='object', to=orm['auth.User'])),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_b', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subject', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'core', ['Friend'])

        # Adding unique constraint on 'Friend', fields ['user_a', 'user_b']
        db.create_unique(u'core_friend', ['user_a_id', 'user_b_id'])
