...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Post', fields ['name']
        db.delete_unique(u'core_post', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Post', fields ['name']
        db.create_unique(u'core_post', ['name'])
