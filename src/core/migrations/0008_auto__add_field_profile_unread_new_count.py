...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.unread_new_count'
        db.add_column('core_profile', 'unread_news_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Profile.unread_new_count'
        db.delete_column('core_profile', 'unread_news_count')
    ...
    models = {
        ...
        'core.profile': {
            ...
            'unread_new_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
