...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_post', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=None, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.category'
        db.add_column(u'core_post', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.NewsCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.slug'
        db.delete_column(u'core_post', 'slug')

        # Deleting field 'Post.category'
        db.delete_column(u'core_post', 'category_id')
