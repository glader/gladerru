...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('core_item', (
            ...
            ('best_answer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='best_answer', null=True, to=orm['core.Comment'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_unique('core_item_tags', ['item_id', 'tag_id'])
