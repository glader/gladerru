...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_tag', (
            ...
            ('primary_synonim', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='synonim', null=True, to=orm['core.Tag'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_tag', null=True, to=orm['core.Tag'])),
            ...
            ('posts', self.gf('django.db.models.fields.TextField')(default='')),
            ('need_recalc', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        ...
        db.create_table(u'core_profile', (
            ...
            ('referer', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ...
            ('unread_news_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('send_news', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        ...
        db.create_table(u'core_tag2skill', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'core', ['Tag2Skill'])
        ...
        db.create_table(u'core_comment', (
            ...
            ('local_url', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Comment'])

        # Adding model 'Rubric'
        db.create_table(u'core_rubric', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250, unique=True, null=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Rubric'], null=True, blank=True)),
            ...
            ('image', self.gf('yafotki.fields.YFField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal(u'core', ['Rubric'])

        # Adding model 'Post'
        db.create_table(u'core_post', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=None, max_length=250, unique=True, null=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(default=None, max_length=255, null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.NewsCategory'], null=True, blank=True)),
            ('content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='pub', max_length=50)),
            ('type', self.gf('django.db.models.fields.CharField')(default='post', max_length=15)),
            ('abstract', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('event_date_start', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('event_date_finish', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('hidden', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('last_comment_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('rating', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('rubric', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Rubric'], null=True, blank=True)),
            ('skill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Skill'], null=True, blank=True)),
            ('tags_str', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=250, null=True, blank=True)),
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('icon', self.gf('yafotki.fields.YFField')(default=None, max_length=255, null=True, blank=True)),
        ...
        m2m_table_name = db.shorten_name(u'core_post_tags')
        ...
        db.create_table(u'core_photo', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='pub', max_length=50)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='core_user', null=True, to=orm['auth.User'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='core_post', null=True, to=orm['core.Post'])),
            ('rider', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='core_rider', null=True, to=orm['movies.Man'])),
            ('photographer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='core_photographer', null=True, to=orm['movies.Man'])),
        ...
        m2m_table_name = db.shorten_name(u'core_photo_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('photo', models.ForeignKey(orm[u'core.photo'], null=False)),
            ('tag', models.ForeignKey(orm[u'core.tag'], null=False))
        ))
        ...
        db.create_table(u'core_keyword', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='manual', max_length=20)),
        ))
        ...
        db.create_table(u'core_image', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('upload', self.gf('yafotki.fields.YFField')(max_length=255)),
        ))
