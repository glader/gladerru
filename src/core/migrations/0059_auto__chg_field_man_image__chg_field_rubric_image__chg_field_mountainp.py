...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rubric.image'
        db.alter_column('core_rubric', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'MountainPhoto.image'
        db.alter_column('core_mountainphoto', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Photo.image'
        db.alter_column('core_photo', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Movie.cover'
        db.alter_column('core_movie', 'cover', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Rubric.image'
        db.alter_column('core_rubric', 'image', self.gf('core.models.ThumbnailImageField')(max_length=100, null=True))

        # Changing field 'MountainPhoto.image'
        db.alter_column('core_mountainphoto', 'image', self.gf('core.models.ThumbnailImageField')(max_length=100))

        # Changing field 'Photo.image'
        db.alter_column('core_photo', 'image', self.gf('core.models.ThumbnailImageField')(max_length=100, null=True))

        # Changing field 'Movie.cover'
        db.alter_column('core_movie', 'cover', self.gf('core.models.ThumbnailImageField')(max_length=100, null=True))
