...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SearchLink.show_page'
        db.add_column('core_searchlink', 'show_page', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True))

    def backwards(self, orm):

        # Deleting field 'SearchLink.show_page'
        db.delete_column('core_searchlink', 'show_page')
