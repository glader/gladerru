...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_news', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='', max_length=20)),
        ...
        # Adding field 'UserNews.news'
        db.add_column('core_usernews', 'news', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.News'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserNews.news'
        db.delete_column('core_usernews', 'news_id')
