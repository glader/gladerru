...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Mountain.light'
        db.delete_column('core_mountain', 'light')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Mountain.light'
        db.add_column('core_mountain', 'light', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)
