...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.favorites_count'
        db.delete_column('core_profile', 'favorites_count')
    ...
    def backwards(self, orm):
        ...
        db.create_unique('core_photo_favorites', ['photo_id', 'profile_id'])

        # Adding field 'Profile.favorites_count'
        db.add_column('core_profile', 'favorites_count',
        ...
        db.create_unique('core_movie_favorites', ['movie_id', 'profile_id'])
