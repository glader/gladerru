...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mountain.newbie'
        db.add_column('core_mountain', 'newbie', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Mountain.cafe'
        db.add_column('core_mountain', 'cafe', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Mountain.proof_url'
        db.add_column('core_mountain', 'proof_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Mountain.check_date'
        db.add_column('core_mountain', 'check_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Mountain.hotel'
        db.add_column('core_mountain', 'hotel', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Mountain.safe'
        db.add_column('core_mountain', 'safe', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Mountain.rental'
        db.add_column('core_mountain', 'rental', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Mountain.room'
        db.add_column('core_mountain', 'room', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Mountain.email'
        db.add_column('core_mountain', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True), keep_default=False)
        # Adding field 'Mountain.rental'
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Mountain.newbie'
        db.delete_column('core_mountain', 'newbie')

        # Deleting field 'Mountain.cafe'
        db.delete_column('core_mountain', 'cafe')

        # Deleting field 'Mountain.proof_url'
        db.delete_column('core_mountain', 'proof_url')

        # Deleting field 'Mountain.check_date'
        db.delete_column('core_mountain', 'check_date')

        # Deleting field 'Mountain.hotel'
        db.delete_column('core_mountain', 'hotel')

        # Deleting field 'Mountain.safe'
        db.delete_column('core_mountain', 'safe')

        # Deleting field 'Mountain.rental'
        db.delete_column('core_mountain', 'rental')

        # Deleting field 'Mountain.room'
        db.delete_column('core_mountain', 'room')
    ...
    models = {
        ...
        'core.mountain': {
            ...
            'service': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'core.userpostnotice': {
            'Meta': {'unique_together': "(('user', 'post'),)", 'object_name': 'UserPostNotice'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Item']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'core.uservisit': {
