...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserNews.content_type'
        db.delete_column('core_usernews', 'content_type_id')

        # Deleting field 'UserNews.date_created'
        db.delete_column('core_usernews', 'date_created')

        # Deleting field 'UserNews.type'
        db.delete_column('core_usernews', 'type')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserNews.content_type'
        db.add_column('core_usernews', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'UserNews.date_created'
        db.add_column('core_usernews', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=1, blank=True), keep_default=False)

        # Adding field 'UserNews.type'
        db.add_column('core_usernews', 'type', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)
