...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Photo.last_comment_date'
        db.delete_column(u'core_photo', 'last_comment_date')

        # Deleting field 'Photo.comment_count'
        db.delete_column(u'core_photo', 'comment_count')

        # Deleting field 'Photo.tags_str'
        db.delete_column(u'core_photo', 'tags_str')
    ...
    def backwards(self, orm):
        # Adding field 'Photo.last_comment_date'
        db.add_column(u'core_photo', 'last_comment_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.comment_count'
        db.add_column(u'core_photo', 'comment_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Photo.tags_str'
        db.add_column(u'core_photo', 'tags_str',
