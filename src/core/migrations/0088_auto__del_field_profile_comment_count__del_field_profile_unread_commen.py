...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.comment_count'
        db.delete_column(u'core_profile', 'comment_count')

        # Deleting field 'Profile.unread_comment_count'
        db.delete_column(u'core_profile', 'unread_comment_count')

        # Deleting field 'Post.ask_for_answer_amount'
        db.delete_column(u'core_post', 'ask_for_answer_amount')

        # Deleting field 'Post.best_answer'
        db.delete_column(u'core_post', 'best_answer_id')

        # Deleting field 'Post.is_question'
        db.delete_column(u'core_post', 'is_question')


    def backwards(self, orm):
        # Adding field 'Profile.comment_count'
        db.add_column(u'core_profile', 'comment_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Profile.unread_comment_count'
        db.add_column(u'core_profile', 'unread_comment_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Post.ask_for_answer_amount'
        db.add_column(u'core_post', 'ask_for_answer_amount',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Post.best_answer'
        db.add_column(u'core_post', 'best_answer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='post_best_answer', null=True, to=orm['core.Comment'], blank=True),
                      keep_default=False)

        # Adding field 'Post.is_question'
        db.add_column(u'core_post', 'is_question',
