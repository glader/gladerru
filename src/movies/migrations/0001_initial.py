    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_synonim', models.ForeignKey(on_delete=models.DO_NOTHING, related_name='synonim', verbose_name='\u041e\u0441\u043d\u043e\u0432\u043d\u043e\u0439 \u0441\u0438\u043d\u043e\u043d\u0438\u043c', blank=True, to='movies.Man', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('man', models.ForeignKey(on_delete=models.DO_NOTHING, verbose_name='\u0427\u0435\u043b\u043e\u0432\u0435\u043a', to='movies.Man')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photographer', models.ForeignKey(on_delete=models.DO_NOTHING, related_name='photographer', verbose_name='\u0424\u043e\u0442\u043e\u0433\u0440\u0430\u0444', blank=True, to='movies.Man', null=True)),
                ('rider', models.ForeignKey(on_delete=models.DO_NOTHING, related_name='rider', verbose_name='\u0420\u0430\u0439\u0434\u0435\u0440', blank=True, to='movies.Man', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=models.DO_NOTHING, verbose_name='\u0424\u0438\u043b\u044c\u043c', to='movies.Movie')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='movie',
            name='studio',
            field=models.ForeignKey(on_delete=models.DO_NOTHING, verbose_name='\u0421\u0442\u0443\u0434\u0438\u044f', blank=True, to='movies.Studio', null=True),
        ),
        migrations.AddField(
            model_name='man2movie',
            name='movie',
            field=models.ForeignKey(on_delete=models.DO_NOTHING, verbose_name='\u0424\u0438\u043b\u044c\u043c', to='movies.Movie'),
        ),
    ]
