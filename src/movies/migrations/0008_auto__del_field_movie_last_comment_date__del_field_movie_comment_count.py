...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Movie.last_comment_date'
        db.delete_column(u'movies_movie', 'last_comment_date')

        # Deleting field 'Movie.comment_count'
        db.delete_column(u'movies_movie', 'comment_count')

        # Deleting field 'Movie.hidden'
        db.delete_column(u'movies_movie', 'hidden')

        # Adding field 'Movie.dt_teaser_added'
        db.add_column(u'movies_movie', 'dt_teaser_added',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.dt_fullmovie_added'
        db.add_column(u'movies_movie', 'dt_fullmovie_added',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.dt_soundtrack_added'
        db.add_column(u'movies_movie', 'dt_soundtrack_added',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Movie.last_comment_date'
        db.add_column(u'movies_movie', 'last_comment_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Movie.comment_count'
        db.add_column(u'movies_movie', 'comment_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Movie.hidden'
        db.add_column(u'movies_movie', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Movie.dt_teaser_added'
        db.delete_column(u'movies_movie', 'dt_teaser_added')

        # Deleting field 'Movie.dt_fullmovie_added'
        db.delete_column(u'movies_movie', 'dt_fullmovie_added')

        # Deleting field 'Movie.dt_soundtrack_added'
        db.delete_column(u'movies_movie', 'dt_soundtrack_added')
