...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mountain.meta_description'
        db.add_column(u'mountains_mountain', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Region.meta_description'
        db.add_column(u'mountains_region', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mountain.meta_description'
        db.delete_column(u'mountains_mountain', 'meta_description')

        # Deleting field 'Region.meta_description'
        db.delete_column(u'mountains_region', 'meta_description')
